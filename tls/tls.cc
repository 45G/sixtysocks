...
static const unordered_map<int, PRErrorCode> DEFAULT_ERRORS = {
	...
	{ EBADMSG,         PR_IO_ERROR },
#endif
	{ EBUSY,           PR_FILESYSTEM_MOUNTED_ERROR },
...
#ifdef EDIRCORRUPTED
	{ EDIRCORRUPTED, PR_DIRECTORY_CORRUPTED_ERROR },
#endif
#ifdef EDQUOT
	{ EDQUOT,          PR_NO_DEVICE_SPACE_ERROR },
#endif
	{ EEXIST,          PR_FILE_EXISTS_ERROR },
	{ EFAULT,          PR_ACCESS_FAULT_ERROR },
	{ EFBIG,           PR_FILE_TOO_BIG_ERROR },
	...
	{ EISDIR,          PR_IS_DIRECTORY_ERROR },
	{ ELOOP,           PR_LOOP_ERROR },
	{ EMFILE,          PR_PROC_DESC_TABLE_FULL_ERROR },
	{ EMLINK,          PR_MAX_DIRECTORY_ENTRIES_ERROR },
	...
	{ EROFS,           PR_READ_ONLY_FILESYSTEM_ERROR },
