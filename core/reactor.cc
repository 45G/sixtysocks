...
size_t Reactor::tcpRecv(UniqFD *fd, StreamBuffer *buf)
{
...
size_t Reactor::tcpSend(UniqFD *fd, StreamBuffer *buf)
{
...
size_t Reactor::tcpSendTFO(UniqFD *fd, StreamBuffer *buf, S6U::SocketAddress dest)
{
...
void Reactor::tcpConnect(UniqFD *fd, S6U::SocketAddress dest)
{
