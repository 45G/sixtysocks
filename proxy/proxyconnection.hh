...
#include "../core/fdxstreamreactor.hh"
#include "../core/timeoutreactor.hh"
#include "timeouts.hh"

class Proxy;

class ProxyConnection: public FDXStreamReactor
{
...
public:
	ProxyConnection(Proxy *proxy, UniqFD &&srcFD);
	
	void start();
	
	void upstreamProcess(int fd, uint32_t events);
